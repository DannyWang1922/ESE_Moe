...
def parse_args():
    ...
    parser.add_argument("--batch_size", type=int, default=config.get("batch_size", 8), help="Batch size for encoding")
...
def main(args):
    ...
    evaluation.run(model, output_folder=args.save_dir, batch_size=args.batch_size)
